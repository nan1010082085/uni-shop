export default {
    props: {
		...
		format: {
            type: String,
            default: ()=> uni.$u.props.datetimePicker.format
        },
		valueFormat: {
            type: String,
            default: ()=> uni.$u.props.datetimePicker.valueFormat
        },
        showInput: {
			type: Boolean,
			default: ()=> uni.$u.props.datetimePicker.showInput
		},
        inputProps:{
            type: Object,
            default: ()=> uni.$u.props.datetimePicker.inputProps
        }
    }
}
