export default {
	props: {
		...
		disabledColor: {
			type: String,
			default: () => uni.$u.props.textarea.disabledColor
        },
		// 是否显示统计字数
		count: {
			type: Boolean,
		...
		backgroundColor: {
			type: String,
			default: () => uni.$u.props.textarea.backgroundColor
        },
		// 边框圆角
		round: {
			type: String,
			default: () => uni.$u.props.textarea.round
        },
		// 边框颜色
		borderColor: {		
			type: String,
			default: () => uni.$u.props.textarea.borderColor
        }
	}
}